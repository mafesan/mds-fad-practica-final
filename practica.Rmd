...
**Comentar que si no hubiéramos separado los dos data frame, se nos eliminarían 929 datos, que pertenecen a los valores 0 de la variable al aplicar el logaritmo**.
...
regfit_full <- leaps::regsubsets(rating_count_tot_new~., data_train_clean, method='forward')
...
```{r}
lm_fit <- lm(rating_count_tot_new~., data=data_train_clean)
summary(lm_fit)
```
