...
```{r} 
data_train_modelo_fwd <- subset(data_train_clean, select=c(rating_count_tot_new, user_rating, user_rating_ver, ipadSc_urls.num, size_bytes_new, lang.num_new,
                                                           rating_12, rating_9, Lifestyle_genre, Utilities_genre))
