...
data_train$cat_17 <- 0
data_train$cat_17 [data_train$cat_rating == '17+'] <-1
data_train$cat_12 <- 0
data_train$cat_12 [data_train$cat_rating == '12+'] <-1
data_train$cat_9 <- 0
data_train$cat_9 [data_train$cat_rating == '9+'] <-1
data_train$cat_4 <- 0
data_train$cat_4 [data_train$cat_rating == '4+'] <-1
```
